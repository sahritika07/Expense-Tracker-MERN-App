...
import income_expense from "../../assets/images/income-expense.png"
import {LuTrendingUpDown} from "react-icons/lu"

const AuthLayout = ({children}) => {
  return (
    <div className="flex">
    <div className='w-screen h-screen md:w-[60vw] px-22 pt-6 pb-12'>
      <h2 className="text-lg font-medium text-black ">Expense Tracker</h2>
      {children}
    </div>

    <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-n0-repeat bg-center overflow-hidden p-8 relative ">
      ...
      <img src={income_expense} alt="" className="w-64 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-400/15" />
    </div>
